...
class CF(object):
    ...
    def print_recommendation(self):
        file1 = open('/Users/macos/Desktop/Data/airbnb/server/Test1.txt', 'w')
        file2 = open('/Users/macos/Desktop/Data/airbnb/server/Test2.txt', 'w')
...
read_file = pd.read_excel ("/Users/macos/Desktop/Data/airbnb/server/comment.xlsx")
read_file.to_csv ("/Users/macos/Desktop/Data/airbnb/server/comment.csv", index = None, header=True) 
ratings = pd.DataFrame(pd.read_csv("/Users/macos/Desktop/Data/airbnb/server/comment.csv", sep = ',', names = r_cols, encoding='latin-1')) 
